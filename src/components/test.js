    ...
    <div className='bg-bjjblue'>
      <section className='container m-auto hb-0 sm:mb-auto sm:min-h-screen flex flex-col sm:flex-row'>
          ...
          <div className="flex justify-center flex-col p-5 pb-20  sm:p-11 w-[100%] sm:w-1/2 text-white">
            ...
            <p className="py-3 text-[1.5rem]">As Founders, we have collectively been a part of the BJJ community for close to 40 years, and we know and understand the challenges and needs.</p>
            ...
            <button onClick={togleMore} className={ readmore ? "visible button mt-5": "invisible button" } >Readmore»</button>
             ...
             <p className="py-3 text-[1.5rem]"><span>Another challenge</span> that a lot of competing athletes are facing, is finding financial support and sponsoring. And that is another part we want to solve through this project.</p>
