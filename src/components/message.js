...
export default function message() {
  return (
    <div className='container flex justify-center items-center min-h-[27rem] m-auto p-11 sm-p-44 text-center'>
      <div className='max-w-[69rem]'>
        <h2 className='text-3xl m-5 text-[red] font-bold'>Philosophy of Jiujitsu</h2>
