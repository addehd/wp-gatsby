  ...
  return (
    ...
    <section className='container mx-auto pb-20 sm:pb-20 p-2 sm:p-11'>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-1 sm:gap-4 mx-auto">
        <div className="col-span-1 h-[11rem] sm:h-[25rem] w-100 bg-cover hue-rotate-15 bg-[url('../media/grid.webp')]">
          <div className="h-full w-full gradient-bg"></div>
        </div>
        <div className="col-span-1 h-[11rem] sm:h-[25rem] w-100 bg-cover bg-[url('../media/grid.webp')]">
           <div className="h-full w-full gradient-bg"></div>
        </div>
        <div className="col-span-1 h-[11rem] sm:h-[25rem] w-100 bg-cover bg-[url('../media/grid.webp')]">
           <div className="h-full w-full gradient-bg"></div>
