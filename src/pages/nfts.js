  ...
  return (
    <>
      ...
      <div className='bg-bjjblue'>
        <section className='container flex flex-col-reverse sm:flex-row m-auto min-h-full sm:min-h-[85vh] justify-center'>
      ...
      <div>
      <div className="bg-[#2d2d4c] bg-[url('../media/texture-lines.webp')] bg-cover">
        <section className='container flex flex-col sm:flex-row m-auto justify-center justify-evenly pt-[7%] pb-[7%] '>
          <div className="rounded-lg bg-bjjblue border-solid border-[1px] border-[#6e84f4] h-auto w-[13rem]">
